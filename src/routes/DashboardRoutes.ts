...
export const DashboardMenu: DashboardMenuProps[] = [
  ...
  },
  {
    ...
    icon: "layers",
    children: [
      { id: uuid(), link: "/integrations/monitoring", name: "Monitoring", icon: "activity" },
      { id: uuid(), link: "/integrations/event/gtm", name: "Event GTM", icon: "tag" },
      { id: uuid(), link: "/integrations/event/direct", name: "Event Direct", icon: "send" },
      { id: uuid(), link: "/integrations/event/server", name: "Event Server", icon: "server" },
      { id: uuid(), link: "/integrations/product", name: "Product", icon: "package" },
      { id: uuid(), link: "/integrations/offline", name: "Offline", icon: "wifi-off" },
      { id: uuid(), link: "/integrations/webpush", name: "Web Push", icon: "bell" },
    ],
  },
  {
    id: uuid(),
