...
import { Col, Row, Card, Toast, ToastContainer, Button, Image, Tab, Nav, Form, Container } from "react-bootstrap";
...
import { BasicToastCode, LiveToastCode, DismissibleToastCode, PlacementCode, PlacementCode2, PlacementCode3, CustomToastCode } from "data/code/ToastsCode";
        ...
        <Col lg={12} md={12} sm={12}>
          <div className='border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between'>
            <div className='mb-3 mb-md-0'>
              ...
              <p className='mb-0 '>Push notifications to your visitors with a toast, a lightweight and easily customizable alert message.</p>
            </div>
          </div>
        </Col>
      </Row>
            ...
            <Card>
              ...
              <Card.Body className='p-0'>
                <Tab.Content>
                  ...
                  <Tab.Pane eventKey='react' className='pb-4 p-4 react-code'>
                    <HighlightCode code={LiveToastCode} />
                  </Tab.Pane>
                </Tab.Content>
              </Card.Body>
            </Card>
            ...
            <Card>
              ...
              <Card.Body className='p-0'>
                <Tab.Content>
                  ...
                  <Tab.Pane eventKey='react' className='pb-4 p-4 react-code'>
                    <HighlightCode code={CustomToastCode} />
                  </Tab.Pane>
                </Tab.Content>
              </Card.Body>
            </Card>
            ...
            <Card>
              ...
              <Card.Body className='p-0'>
                <Tab.Content>
                  <Tab.Pane eventKey='design' className='pb-4 p-4'>
                    ...
                    <div className='mb-3'>
                      ...
                      <Form.Select id='selectToastPlacement' className='mt-2' onChange={(e) => setPosition(e.currentTarget.value)}>
                        {["top-start", "top-center", "top-end", "middle-start", "middle-center", "middle-end", "bottom-start", "bottom-center", "bottom-end"].map((p) => (
                    ...
                    <div aria-live='polite' aria-atomic='true' className='position-relative' style={{ minHeight: "240px" }}>
                      <ToastContainer className='p-3' position={position as ToastPosition}>
                        <Toast>
                  ...
                  <Tab.Pane eventKey='react' className='pb-4 p-4 react-code'>
                    <HighlightCode code={PlacementCode} />
                  </Tab.Pane>
                </Tab.Content>
              </Card.Body>
            </Card>
            ...
            <Card>
              ...
              <Card.Body className='p-0'>
                <Tab.Content>
                  ...
                  <Tab.Pane eventKey='react' className='pb-4 p-4 react-code'>
                    <HighlightCode code={DismissibleToastCode} />
                  </Tab.Pane>
                </Tab.Content>
              </Card.Body>
            </Card>
